...
export default function HeroTexts() {
  return (
    <div className="flex flex-col justify-between w-full h-full col-span-8 gap-8 bg-rigid-black text-clear-white rounded-[2rem] max-sm:rounded-[1.5rem] p-8 pt-18 max-sm:px-6 max-sm:py-8 max-sm:gap-18">
      ...
      <div className="flex justify-between max-sm:flex-col-reverse max-sm:gap-12">
